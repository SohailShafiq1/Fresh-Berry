    ...
    <section className={s.heroSection}>
      ...
      <div className={s.topText}>
        <h1 className={s.heading}>
          <span style={{ color: '#016327' }}>U</span>
          <span style={{ color: '#D72323' }}>A</span>
          <span style={{ color: '#016327' }}>E</span>
          <span style={{ color: '#222' }}>'s NO.1 </span>
          <span style={{ color: '#FFA928' }}>HORECA</span>
          <span style={{ color: '#222' }}> PARTNER</span>
        </h1>
      ...
      <div className={s.heroContent}>
        ...
        <div className={s.centerImageBlock}>
          <img src={freshImg} alt="Fresh Fruits and Vegetables" className={s.freshImg} />
        </div>
        <div className={s.rightBlock}>
          <div className={s.whyTagline}>{taglines[taglineIndex]}</div>
          <div className={s.whyUsBox}>
            <FaQuestionCircle className={s.whyUsIcon} style={{ color: '#5C128B', fontSize: '2.2rem', marginBottom: '8px' }} />
            <svg width="60" height="40" viewBox="0 0 60 40" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M10 30 Q30 10 50 30" stroke="#5C128B" strokeWidth="2" fill="none" />
              <circle cx="10" cy="30" r="2" fill="#5C128B" />
              <circle cx="50" cy="30" r="2" fill="#5C128B" />
              <circle cx="30" cy="10" r="2" fill="#5C128B" />
            </svg>
            <div className={s.whyUsText} style={{ color: '#5C128B', fontWeight: 700 }}>Why Us?</div>
          </div>
        </div>
      </div>
    </section>
